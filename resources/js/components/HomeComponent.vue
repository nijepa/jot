<template>
    <div >
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
             ...
             preserveAspectRatio="xMidYMid meet" class=" text-red-700  h-64 w-64">
        ...
        <div class="pt-3">
            <p class="font-bold text-blue-600 text-3xl">Hi ! </p>
            <p class="font-bold text-blue-600 text-xl">Lets connect and track our mates .)</p>
        </div>
