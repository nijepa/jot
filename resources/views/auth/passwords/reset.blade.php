    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="relative">
                ...
                <div class="">
                    <input id="email" type="email" class="text-red-800 text-sm pt-1" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
                    @error('email')
            ...
            <div class="relative pt-3">
                ...
                <div class="">
                    <input id="password" type="password" class="text-red-800 text-sm pt-1r" name="password" autocomplete="new-password">
                    @error('password')
                    <span class="text-red-800 text-sm pt-1" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="pt-2">
                ...
                <div class="">
                    <input id="password-confirm" type="password" class="text-red-800 text-sm pt-1" name="password_confirmation" required autocomplete="new-password">
                </div>
            </div>
